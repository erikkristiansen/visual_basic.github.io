...
'Purpose:       The trends Menswear Inventory Windows Application determines the 
'               depreciation based on a 5-year life of items in inventory using 
...
Public Class frmDepreciation
    ...
    Public Shared _intSizeOfArray As Integer = 8
    ...
    Private Sub frmDepreciation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'The frmDepreciation load event reads the inventory text file and fills the Listbox
        'object with the inventory items 

        'Initialize an instance of the StreamReader object and declares variables
        Dim objReader As IO.StreamReader
        Dim strLocationAndNameOfFile As String = "J:\Trends Menswear Inventory Depreciation Application\inventory.txt"
        ...
        If IO.File.Exists(strLocationAndNameOfFile) Then
            ...
            Do While (objReader.Peek() > -1)
                ...
                lstInventoryId.Items.Add(_strItemId(intCount))
    ...
    Private Sub btnCalculateDepreciation_Click(sender As Object, e As EventArgs) Handles btnCalculateDepreciation.Click
        'The btnCalculates click event calls the depreciation Sub procedures
        'Declare variables
    ...
    Private Sub StraightLineDepreciation(ByVal intItemId As Integer)
        ...
        MakeObjectsVisible()
        'Displays the item and quantity of the selected item 
    ...
    Private Sub DoubleDecliningDepreciation(ByVal intItemId As Integer)
        ...
        'balance depreciationfor the item selected
        Dim intDoublePresentYear As Integer
        Dim decDoublePresentValue As Decimal = 0
        ...
        decDoublePresentValue = _decInitialPrice(intItemId)
    ...
    Private Sub mnuClear_Click(sender As Object, e As EventArgs) Handles mnuClear.Click
        'The munClear click event clears and resets the form 
    ...
    Private Sub mnuExit_Click(sender As Object, e As EventArgs) Handles mnuExit.Click
        'The mnuEixt click event closes the application
        Application.Exit()
